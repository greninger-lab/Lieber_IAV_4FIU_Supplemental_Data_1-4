...
rava.final.path <- paste0(getwd(),"/rava_final_tables_by_lineage/")
...
rava.final$Passage<- str_replace_all(rava.final$Passage, c("-rep2" = ""))
...
write.csv(final_hyb_lin_specific, file = "adaptation_RAVA_output_to_figure_input/adaptation_summary_lineage_mutations.csv")

write.csv(no_lin_muts, file = "adaptation_RAVA_output_to_figure_input/adaptation_samples_without_lineage_mutations.csv")

write.csv(insufficient_depth, file = "adaptation_RAVA_output_to_figure_input/adaptation_insufficient_depth.csv")